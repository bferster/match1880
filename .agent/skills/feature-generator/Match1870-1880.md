...
**PHASE 2** {
	...
	For each candidate pair, calculate a  weighted point score {
		...
		**Name match:** 
		...
		else if last_name is Identical in both datasets and the first_name is only one letter and the first initial of first_name is identical in datasets then add +40 points.
		else if last_name is Identical in both datasets and the first initial of first_name is identical in datasets then add +20 points.	
		else if first_name Jaro-Winkler score is ≥0.85 then add +20 points. 
